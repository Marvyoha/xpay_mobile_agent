...
class SendMoneyInputWidget extends StatefulWidget {
  ...
  @override
  State<SendMoneyInputWidget> createState() => _PrimaryInputWidgetState();
}

class _PrimaryInputWidgetState extends State<SendMoneyInputWidget> {
  FocusNode? focusNode;
