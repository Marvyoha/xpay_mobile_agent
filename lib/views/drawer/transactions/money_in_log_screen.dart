...
class MoneyInLogScreen extends StatelessWidget {
  const MoneyInLogScreen({Key? key, required this.controller})
      : super(key: key);
  ...
  _mainListWidget(int i, List<MoneyIn> data, BuildContext context) {
      ...
      child: Column(
        children: [
          TransactionWidget(
            ...
            timeText: DateFormat('jm').format(data[i].dateTime.toLocal()),
                  ...
                  child: Column(
                    children: [
                      ...
                      ExpendedItemWidget(
                        ...
                        value:
                            '${DateFormat('yyyy-MM-dd').format(data[i].dateTime)} | ${DateFormat('jm').format(data[i].dateTime.toLocal())}',
                      ),
                    ],
                  ),
                ),
